...
public class ElementTests {
	...
	public void testElementText()
	{
		...
		Assert.assertEquals("The value of the special text for color is not equal", 
				"Click on me and my color will change", messageText);
	...
	public void testElementStyle()
	{
		...
		System.out.println("tag nejma: " + message.getTagName());
		
		Assert.assertEquals("p", message.getTagName());
	}
